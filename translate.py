...
print(os.getcwd())
# 获取src下所有文件
__src__files = os.listdir(os.getcwd() + "/element/translate/")
# 打印文件集合
print(__src__files)

file_read = open(os.getcwd() + "/element/translate/" + "src.log", "r", encoding="utf-8")
# 将文件内容保存到内存
lines = file_read.readlines()
file_write = open(os.getcwd() + "/element/translate/" + "translate.log", "w", encoding="utf-8")
for line in lines:
