...
android_colors = readXmlFile(os.getcwd() + "/element/src/" + "colors.xml")
androidDict = {}
...
pprint('==========================================================')
string_json = readJson(os.getcwd() + "/element/src/" + "color.json")
ohosDict = {}
...
with open(os.getcwd() + "/element/des/" + "color.json", 'w', encoding="utf-8") as f:
