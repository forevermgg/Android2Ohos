...
pprint(os.getcwd())
# 获取src下所有文件
__src__files = os.listdir(os.getcwd() + "/element/src/")
# 打印文件集合
pprint(__src__files)

android_strings = readXmlFile(os.getcwd() + "/element/src/" + "strings.xml")
androidDict = {}
...
pprint('==========================================================')
string_json = readJson(os.getcwd() + "/element/src/" + "string.json")
ohosDict = {}
...
with open(os.getcwd() + "/element/des/" + "string.json", 'w', encoding="utf-8") as f:
